; XMate v2.7.0 Installer Script
; Stable release — CLAUDE.md refactored (931→137 lines), docs cleaned & synced:
;   27 pitfalls documented, 8 core docs streamlined, workflow simplified,
;   module details moved to dedicated docs (quicklook/file-search/annotate/
;   libretranslate/plugin-window/ole-drag-out)
...
OutputBaseFilename=XMate_Setup_v2.7.0
