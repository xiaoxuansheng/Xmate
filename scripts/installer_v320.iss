; XMate v3.2.0 Installer Script
; Dual-engine OCR: PP-OCRv6 (Chinese) + WinRT Windows.Media.Ocr (English)
...
OutputBaseFilename=XMate_Setup_v3.2.0
...
Source: "{#SourcePath}\ffmpeg-9.dll"; DestDir: "{app}"; Flags: ignoreversion
